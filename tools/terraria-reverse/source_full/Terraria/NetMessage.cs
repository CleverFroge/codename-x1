	...
	public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, NetworkText text = null, int number = 0, float number2 = 0f, float number3 = 0f, float number4 = 0f, int number5 = 0, int number6 = 0, int number7 = 0)
	{
		...
		lock (buffer[num])
		{
			...
			case 4:
			{
				...
				bitsByte21[2] = player5.extraAccessory;
				writer.Write(bitsByte21);
				BitsByte bitsByte22 = (byte)0;
				bitsByte22[0] = player5.UsingBiomeTorches;
				bitsByte22[1] = player5.happyFunTorchTime;
				bitsByte22[2] = player5.unlockedBiomeTorches;
				bitsByte22[3] = player5.unlockedSuperCart;
				bitsByte22[4] = player5.enabledSuperCart;
				writer.Write(bitsByte22);
				BitsByte bitsByte23 = (byte)0;
				bitsByte23[0] = player5.usedAegisCrystal;
				bitsByte23[1] = player5.usedAegisFruit;
				bitsByte23[2] = player5.usedArcaneCrystal;
				bitsByte23[3] = player5.usedGalaxyPearl;
				bitsByte23[4] = player5.usedGummyWorm;
				bitsByte23[5] = player5.usedAmbrosia;
				bitsByte23[6] = player5.ateArtisanBread;
			...
			case 5:
			{
				...
				bitsByte5[0] = item5.favorited;
				bitsByte5[1] = number3 != 0f;
			...
			case 7:
			{
				...
				bitsByte6[0] = Main.dayTime;
				bitsByte6[1] = Main.bloodMoon;
				bitsByte6[2] = Main.eclipse;
				...
				bitsByte7[0] = WorldGen.shadowOrbSmashed;
				bitsByte7[1] = NPC.downedBoss1;
				bitsByte7[2] = NPC.downedBoss2;
				bitsByte7[3] = NPC.downedBoss3;
				bitsByte7[4] = Main.hardMode;
				bitsByte7[5] = NPC.downedClown;
				bitsByte7[7] = NPC.downedPlantBoss;
				writer.Write(bitsByte7);
				BitsByte bitsByte8 = (byte)0;
				bitsByte8[0] = NPC.downedMechBoss1;
				bitsByte8[1] = NPC.downedMechBoss2;
				bitsByte8[2] = NPC.downedMechBoss3;
				bitsByte8[3] = NPC.downedMechBossAny;
				bitsByte8[4] = Main.cloudBGActive >= 1f;
				bitsByte8[5] = WorldGen.crimson;
				bitsByte8[6] = Main.pumpkinMoon;
				bitsByte8[7] = Main.snowMoon;
				writer.Write(bitsByte8);
				BitsByte bitsByte9 = (byte)0;
				bitsByte9[1] = Main.fastForwardTimeToDawn;
				bitsByte9[2] = Main.slimeRain;
				bitsByte9[3] = NPC.downedSlimeKing;
				bitsByte9[4] = NPC.downedQueenBee;
				bitsByte9[5] = NPC.downedFishron;
				bitsByte9[6] = NPC.downedMartians;
				bitsByte9[7] = NPC.downedAncientCultist;
				writer.Write(bitsByte9);
				BitsByte bitsByte10 = (byte)0;
				bitsByte10[0] = NPC.downedMoonlord;
				bitsByte10[1] = NPC.downedHalloweenKing;
				bitsByte10[2] = NPC.downedHalloweenTree;
				bitsByte10[3] = NPC.downedChristmasIceQueen;
				bitsByte10[4] = NPC.downedChristmasSantank;
				bitsByte10[5] = NPC.downedChristmasTree;
				bitsByte10[6] = NPC.downedGolemBoss;
				bitsByte10[7] = BirthdayParty.PartyIsUp;
				writer.Write(bitsByte10);
				BitsByte bitsByte11 = (byte)0;
				bitsByte11[0] = NPC.downedPirates;
				bitsByte11[1] = NPC.downedFrost;
				bitsByte11[2] = NPC.downedGoblins;
				bitsByte11[3] = Sandstorm.Happening;
				bitsByte11[4] = DD2Event.Ongoing;
				bitsByte11[5] = DD2Event.DownedInvasionT1;
				bitsByte11[6] = DD2Event.DownedInvasionT2;
				bitsByte11[7] = DD2Event.DownedInvasionT3;
				writer.Write(bitsByte11);
				BitsByte bitsByte12 = (byte)0;
				bitsByte12[0] = NPC.combatBookWasUsed;
				bitsByte12[1] = LanternNight.LanternsUp;
				bitsByte12[2] = NPC.downedTowerSolar;
				bitsByte12[3] = NPC.downedTowerVortex;
				bitsByte12[4] = NPC.downedTowerNebula;
				bitsByte12[5] = NPC.downedTowerStardust;
				bitsByte12[6] = Main.forceHalloweenForToday;
				bitsByte12[7] = Main.forceXMasForToday;
				writer.Write(bitsByte12);
				BitsByte bitsByte13 = (byte)0;
				bitsByte13[0] = NPC.boughtCat;
				bitsByte13[1] = NPC.boughtDog;
				bitsByte13[2] = NPC.boughtBunny;
				bitsByte13[3] = NPC.freeCake;
				bitsByte13[4] = Main.drunkWorld;
				bitsByte13[5] = NPC.downedEmpressOfLight;
				bitsByte13[6] = NPC.downedQueenSlime;
				bitsByte13[7] = Main.getGoodWorld;
				writer.Write(bitsByte13);
				BitsByte bitsByte14 = (byte)0;
				bitsByte14[0] = Main.tenthAnniversaryWorld;
				bitsByte14[1] = Main.dontStarveWorld;
				bitsByte14[2] = NPC.downedDeerclops;
				bitsByte14[3] = Main.notTheBeesWorld;
				bitsByte14[4] = Main.remixWorld;
				bitsByte14[5] = NPC.unlockedSlimeBlueSpawn;
				bitsByte14[6] = NPC.combatBookVolumeTwoWasUsed;
				bitsByte14[7] = NPC.peddlersSatchelWasUsed;
				writer.Write(bitsByte14);
				BitsByte bitsByte15 = (byte)0;
				bitsByte15[0] = NPC.unlockedSlimeGreenSpawn;
				bitsByte15[1] = NPC.unlockedSlimeOldSpawn;
				bitsByte15[2] = NPC.unlockedSlimePurpleSpawn;
				bitsByte15[3] = NPC.unlockedSlimeRainbowSpawn;
				bitsByte15[4] = NPC.unlockedSlimeRedSpawn;
				bitsByte15[5] = NPC.unlockedSlimeYellowSpawn;
				bitsByte15[6] = NPC.unlockedSlimeCopperSpawn;
				bitsByte15[7] = Main.fastForwardTimeToDusk;
				writer.Write(bitsByte15);
				BitsByte bitsByte16 = (byte)0;
				bitsByte16[0] = Main.noTrapsWorld;
				bitsByte16[1] = Main.zenithWorld;
				bitsByte16[2] = NPC.unlockedTruffleSpawn;
				bitsByte16[3] = Main.vampireSeed;
				bitsByte16[4] = Main.infectedSeed;
				bitsByte16[5] = Main.teamBasedSpawnsSeed;
				bitsByte16[6] = Main.skyblockWorld;
				bitsByte16[7] = Main.dualDungeonsSeed;
				writer.Write(bitsByte16);
				BitsByte bitsByte17 = (byte)0;
				bitsByte17[0] = WorldGen.Skyblock.lowTiles;
			...
			case 13:
			{
				...
				bitsByte24[0] = player6.controlUp;
				bitsByte24[1] = player6.controlDown;
				bitsByte24[2] = player6.controlLeft;
				bitsByte24[3] = player6.controlRight;
				bitsByte24[4] = player6.controlJump;
				bitsByte24[5] = player6.controlUseItem;
				bitsByte24[6] = player6.direction == 1;
				writer.Write(bitsByte24);
				BitsByte bitsByte25 = (byte)0;
				bitsByte25[0] = player6.pulley;
				bitsByte25[1] = player6.pulley && player6.pulleyDir == 2;
				bitsByte25[2] = player6.velocity != Vector2.Zero;
				bitsByte25[3] = player6.vortexStealthActive;
				bitsByte25[4] = player6.gravDir == 1f;
				bitsByte25[5] = player6.shieldRaised;
				bitsByte25[6] = player6.ghost;
				bitsByte25[7] = player6.mount.Active;
				writer.Write(bitsByte25);
				BitsByte bitsByte26 = (byte)0;
				bitsByte26[0] = player6.tryKeepingHoveringUp;
				bitsByte26[1] = player6.IsVoidVaultEnabled;
				bitsByte26[2] = player6.sitting.isSitting;
				bitsByte26[3] = player6.downedDD2EventAnyDifficulty;
				bitsByte26[4] = player6.petting.isPetting;
				bitsByte26[5] = player6.petting.isPetSmall;
				bitsByte26[6] = player6.PotionOfReturnOriginalUsePosition.HasValue;
				bitsByte26[7] = player6.tryKeepingHoveringDown;
				writer.Write(bitsByte26);
				BitsByte bitsByte27 = (byte)0;
				bitsByte27[0] = player6.sleeping.isSleeping;
				bitsByte27[1] = player6.autoReuseAllWeapons;
				bitsByte27[2] = player6.controlDownHold;
				bitsByte27[3] = player6.isOperatingAnotherEntity;
				bitsByte27[4] = player6.controlUseTile;
				bitsByte27[5] = player6.netCameraTarget.HasValue;
				bitsByte27[6] = player6.lastItemUseAttemptSuccess;
			...
			case 27:
			{
				...
				bitsByte28[0] = projectile.ai[0] != 0f;
				bitsByte28[1] = projectile.ai[1] != 0f;
				bitsByte29[0] = projectile.ai[2] != 0f;
