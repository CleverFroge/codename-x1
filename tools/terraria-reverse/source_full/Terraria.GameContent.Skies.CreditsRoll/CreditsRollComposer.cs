...
public class CreditsRollComposer
{
	...
	private SegmentInforReport PlaySegment_PrincessAndEveryoneThanksPlayer(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(0f, -92f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_GuideEmotingAtRainbowPanel(int startTime)
	{
		...
		DrawData data = new DrawData(val.Value, Vector2.Zero, null, Color.White, 0f, val.Size() / 2f, 0.25f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_DryadSayingByeToTavernKeep(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		Rectangle rectangle = val.Frame();
		DrawData data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(num2, -42f), 1f, SpriteEffects.None);
		...
		DrawData data2 = new DrawData(val2.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
		...
		DrawData data3 = new DrawData(val3.Value, Vector2.Zero, rectangle3, Color.White, 0f, rectangle3.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_SteampunkerRepairingCyborg(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		rectangle = val.Frame();
		data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(num2, -42f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_SantaAndTaxCollectorThrowingPresents(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		Rectangle rectangle2 = val2.Frame(1, 8);
		DrawData data2 = new DrawData(val2.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.FlipHorizontally);
	...
	private SegmentInforReport PlaySegment_Grox_WitchDoctorGoingToHisPeople(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data2 = new DrawData(val2.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
		new DrawData(val2.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.FlipHorizontally);
	...
	private SegmentInforReport PlaySegment_DryadTurningToTree(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		Rectangle rectangle = val.Frame();
		DrawData data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(0f, -42f), 1f, SpriteEffects.None);
		Segments.AnimationSegmentWithActions<Segments.LooseSprite> animationSegmentWithActions = new Segments.SpriteSegment(val, num, data, sceneAnchorPosition + _backgroundOffset).UseShaderEffect(new Segments.SpriteSegment.MaskedFadeEffect()).Then(new Actions.Sprites.Fade(0f)).With(new Actions.Sprites.Fade(1f, 60));
	...
	private SegmentInforReport PlaySegment_SantaItemExample(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		for (int i = 0; i < num; i++)
		{
			...
			DrawData data = new DrawData(val.Value, Vector2.Zero, null, Color.White, 0f, val.Size() / 2f, 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_SkeletonMerchantSearchesThroughBones(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data2 = new DrawData(val2.Value, Vector2.Zero, null, Color.White, 0f, val2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
		...
		DrawData data3 = new DrawData(val3.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.FlipHorizontally);
		...
		DrawData drawData = new DrawData(val4.Value, Vector2.Zero, null, Color.White, 0f, val4.Size() / 2f, 1f, SpriteEffects.None);
		Main.instance.LoadItem(1274);
		Asset<Texture2D> val5 = TextureAssets.Item[1274];
		DrawData drawData2 = new DrawData(val5.Value, Vector2.Zero, null, Color.White, 0f, val5.Size() / 2f, 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_ZoologistAndPetsAnnoyGolfer(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data2 = new DrawData(val2.Value, Vector2.Zero, null, Color.White, 0f, val2.Size() / 2f, 1f, SpriteEffects.None);
