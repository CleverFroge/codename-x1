...
public class EasyDeserializationJsonContractResolver : DefaultContractResolver
{
	...
	{
		JsonContract val = ((DefaultContractResolver)this).CreateContract(objectType);
		if (val is JsonStringContract && objectType != typeof(string))
		{
			...
			{
				val = (JsonContract)(object)((DefaultContractResolver)this).CreateObjectContract(objectType);
			}
		}
