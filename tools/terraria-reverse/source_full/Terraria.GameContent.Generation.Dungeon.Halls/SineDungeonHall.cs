...
public class SineDungeonHall : DungeonHall
{
	...
	public void SineHall(DungeonData data, Vector2D startPoint, Vector2D endPoint, bool generating = false)
	{
		...
		dungeonRoomSearchSettings.Fluff = (int)((float)num * sineDungeonHallSettings.Magnitude) + num2;
		DungeonRoomSearchSettings dungeonRoomSearchSettings2 = dungeonRoomSearchSettings;
		List<DungeonRoom> allRoomsInSpots = DungeonUtils.GetAllRoomsInSpots(data.dungeonRooms, startPoint, endPoint, dungeonRoomSearchSettings2);
		Vector2D val3 = val2;
