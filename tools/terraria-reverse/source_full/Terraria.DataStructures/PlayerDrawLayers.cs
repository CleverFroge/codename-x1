...
public static class PlayerDrawLayers
{
	...
	public static void DrawPlayer_09_Wings(ref PlayerDrawSet drawinfo)
	{
		...
		if (drawinfo.drawPlayer.wings == 51)
		{
			...
			rectangle3.Width -= 2;
			rectangle3.Height -= 2;
			item = new DrawData(value3, vec4.Floor(), rectangle3, color6, drawinfo.drawPlayer.bodyRotation, rectangle3.Size() / 2f, 1f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
			return;
		}
		if (drawinfo.drawPlayer.wings == 47)
		{
			...
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
			item = new DrawData(TextureAssets.GlowMask[366].Value, vec5.Floor(), rectangle4, chickenBonesGlowColor, drawinfo.drawPlayer.bodyRotation, rectangle4.Size() / 2f, 1f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
			return;
		}
		if (drawinfo.drawPlayer.wings == 49)
		{
			...
			rectangle5.Width -= 2;
			rectangle5.Height -= 2;
			item = new DrawData(value5, vec6.Floor(), rectangle5, colorArmorBody4, drawinfo.drawPlayer.bodyRotation, rectangle5.Size() / 2f, 1f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
			return;
		}
		...
		if (drawinfo.drawPlayer.wings == 39)
		{
			if (drawinfo.drawPlayer.ShouldDrawWingsThatAreAlwaysAnimated())
			{
				...
				rectangle8.Width -= 2;
				rectangle8.Height -= 2;
				item = new DrawData(value8, vec9.Floor(), rectangle8, colorArmorBody6, drawinfo.drawPlayer.bodyRotation, rectangle8.Size() / 2f, 1f, drawinfo.playerEffect);
				item.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(item);
			}
			return;
		...
		if (drawinfo.drawPlayer.wings == 50)
		{
			...
			item = new DrawData(value9, vec10.Floor(), value10, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num11 / 2), 1f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
			...
			item = new DrawData(TextureAssets.Wings[drawinfo.drawPlayer.wings].Value, vec10.Floor(), value10, color8, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / num11 / 2), 1f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
			return;
		}
	...
	public static void DrawPlayer_21_Head(ref PlayerDrawSet drawinfo)
	{
		...
		if (flag4 && drawinfo.drawPlayer.head == 214 && !drawinfo.drawPlayer.invis)
		{
			...
			if (num22 >= num23)
			{
				color7 = Color.Lerp(Color.Transparent, new Color(200, 200, 200, 0), Utils.GetLerpValue(num23, num24, num22, clamped: true));
			}
			if (num22 >= num24)
			{
				color7 = Color.Lerp(Color.Transparent, new Color(200, 200, 200, 0), Utils.GetLerpValue(1f, num24, num22, clamped: true));
			}
	...
	public static void DrawPlayer_27_HeldItem(ref PlayerDrawSet drawinfo)
	{
		...
		case 46:
		{
			...
			color = Color.Lerp(Color.Transparent, new Color(255, 255, 255, 127) * 0.7f, amount2);
			break;
		}
		case 204:
		...
		case 3476:
		{
			...
			Vector2 origin2 = rectangle2.Size() / 2f;
			item = new DrawData(value3, (drawinfo.ItemLocation - Main.screenPosition + vector4).Floor(), rectangle2, heldItem.GetAlpha(drawinfo.itemColor).MultiplyRGBA(new Color(new Vector4(0.5f, 0.5f, 0.5f, 0.8f))), drawinfo.drawPlayer.itemRotation, origin2, adjustedItemScale, drawinfo.itemEffect);
			drawinfo.DrawDataCache.Add(item);
			value3 = TextureAssets.GlowMask[195].Value;
			item = new DrawData(value3, (drawinfo.ItemLocation - Main.screenPosition + vector4).Floor(), rectangle2, new Color(250, 250, 250, heldItem.alpha) * 0.5f, drawinfo.drawPlayer.itemRotation, origin2, adjustedItemScale, drawinfo.itemEffect);
			drawinfo.DrawDataCache.Add(item);
			return;
		}
		case 4049:
		{
			...
			item = new DrawData(value4, (drawinfo.ItemLocation - Main.screenPosition + vector5).Floor(), rectangle3, heldItem.GetAlpha(drawinfo.itemColor), drawinfo.drawPlayer.itemRotation, origin3, adjustedItemScale, drawinfo.itemEffect);
			drawinfo.DrawDataCache.Add(item);
			return;
		}
		case 3779:
		{
			...
			Color color2 = new Color(120, 40, 222, 0) * (num4 / 2f * 0.3f + 0.85f) * 0.5f;
			num4 = 2f;
			for (float num5 = 0f; num5 < 4f; num5 += 1f)
			{
				item = new DrawData(TextureAssets.GlowMask[218].Value, (drawinfo.ItemLocation - Main.screenPosition + vector6).Floor() + (num5 * ((float)Math.PI / 2f)).ToRotationVector2() * num4, rectangle4, color2, drawinfo.drawPlayer.itemRotation, origin4, adjustedItemScale, drawinfo.itemEffect);
				drawinfo.DrawDataCache.Add(item);
			}
			item = new DrawData(texture2D, (drawinfo.ItemLocation - Main.screenPosition + vector6).Floor(), rectangle4, heldItem.GetAlpha(drawinfo.itemColor).MultiplyRGBA(new Color(new Vector4(0.5f, 0.5f, 0.5f, 0.8f))), drawinfo.drawPlayer.itemRotation, origin4, adjustedItemScale, drawinfo.itemEffect);
			drawinfo.DrawDataCache.Add(item);
			return;
		}
		}
		if (heldItem.useStyle == 5)
		{
			...
			if (num == 3788)
			{
				...
				Color color4 = new Color(80, 40, 252, 0) * (num10 / 2f * 0.3f + 0.85f) * 0.5f;
		...
		if (heldItem.type == 5462 && drawinfo.SelectedDrawnProjectile != null)
		{
			...
			if (selectedDrawnProjectile2.active && selectedDrawnProjectile2.type == 1040)
			{
				...
				color = Color.Lerp(value2: new Color(255, 180, 60, 0), value1: Color.Transparent, amount: Utils.Remap(selectedDrawnProjectile2.ai[1], 0f, 30f, 0f, 1f));
