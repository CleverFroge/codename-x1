...
public class BestiaryDatabaseNPCsPopulator
{
	...
	private void AddNPCBiomeRelationships_Automated()
	{
		...
		FindEntryByNPCID(689).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Times.NightTime });
		...
		FindEntryByNPCID(690).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Biomes.Graveyard });
		...
		FindEntryByNPCID(693).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Biomes.TheDungeon });
		FindEntryByNPCID(694).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Biomes.TheDungeon });
		...
		FindEntryByNPCID(691).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Biomes.Graveyard });
		...
		FindEntryByNPCID(692).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Biomes.Ocean });
