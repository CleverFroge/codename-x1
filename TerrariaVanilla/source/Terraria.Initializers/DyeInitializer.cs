...
public static class DyeInitializer
{
	...
	private static void LoadLegacyHairdyes()
	{
		...
		{
			float num28 = (float)(Main.worldSurface * 0.45) * 16f;
			float num29 = (float)(Main.worldSurface + Main.rockLayer) * 8f;
			float num30 = (float)(Main.rockLayer + (double)Main.maxTilesY) * 8f;
			float num31 = (float)(Main.maxTilesY - 150) * 16f;
			Vector2 center = player.Center;
			if (center.Y < num28)
			{
				float num32 = center.Y / num28;
				float num33 = 1f - num32;
				newColor.R = (byte)(116f * num33 + 28f * num32);
				newColor.G = (byte)(160f * num33 + 216f * num32);
				newColor.B = (byte)(249f * num33 + 94f * num32);
			}
			else if (center.Y < num29)
			{
				float num34 = num28;
				float num35 = (center.Y - num34) / (num29 - num34);
				float num36 = 1f - num35;
				newColor.R = (byte)(28f * num36 + 151f * num35);
				newColor.G = (byte)(216f * num36 + 107f * num35);
				newColor.B = (byte)(94f * num36 + 75f * num35);
			}
			else if (center.Y < num30)
			{
				float num37 = num29;
				float num38 = (center.Y - num37) / (num30 - num37);
				float num39 = 1f - num38;
				newColor.R = (byte)(151f * num39 + 128f * num38);
				newColor.G = (byte)(107f * num39 + 128f * num38);
				newColor.B = (byte)(75f * num39 + 128f * num38);
			}
			else if (center.Y < num31)
			{
				float num40 = num30;
				float num41 = (center.Y - num40) / (num31 - num40);
				float num42 = 1f - num41;
				newColor.R = (byte)(128f * num42 + 255f * num41);
				newColor.G = (byte)(128f * num42 + 50f * num41);
				newColor.B = (byte)(128f * num42 + 15f * num41);
			}
			else
			{
		...
		GameShaders.Hair.BindShader(1980, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			for (int i = 0; i < 54; i++)
			{
				...
				{
					num16 += player.inventory[i].stack;
				}
			...
			if ((float)num16 < num17)
			{
				...
				newColor.R = (byte)((float)(int)color8.R * num21 + (float)(int)color9.R * num20);
				newColor.G = (byte)((float)(int)color8.G * num21 + (float)(int)color9.G * num20);
				newColor.B = (byte)((float)(int)color8.B * num21 + (float)(int)color9.B * num20);
			}
			else if ((float)num16 < num18)
			{
				...
				newColor.R = (byte)((float)(int)color9.R * num24 + (float)(int)color10.R * num23);
				newColor.G = (byte)((float)(int)color9.G * num24 + (float)(int)color10.G * num23);
				newColor.B = (byte)((float)(int)color9.B * num24 + (float)(int)color10.B * num23);
			}
			else if ((float)num16 < num19)
			{
				...
				newColor.R = (byte)((float)(int)color10.R * num27 + (float)(int)color11.R * num26);
				newColor.G = (byte)((float)(int)color10.G * num27 + (float)(int)color11.G * num26);
				newColor.B = (byte)((float)(int)color10.B * num27 + (float)(int)color11.B * num26);
			}
			else
			{
				newColor = color11;
		...
		GameShaders.Hair.BindShader(1981, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			if (Main.dayTime)
			{
				...
				{
					float num6 = (float)(Main.time / 27000.0);
					float num7 = 1f - num6;
					newColor.R = (byte)((float)(int)color4.R * num7 + (float)(int)color5.R * num6);
					newColor.G = (byte)((float)(int)color4.G * num7 + (float)(int)color5.G * num6);
					newColor.B = (byte)((float)(int)color4.B * num7 + (float)(int)color5.B * num6);
				}
				else
				{
					float num8 = 27000f;
					float num9 = (float)((Main.time - (double)num8) / (54000.0 - (double)num8));
					float num10 = 1f - num9;
					newColor.R = (byte)((float)(int)color5.R * num10 + (float)(int)color6.R * num9);
					newColor.G = (byte)((float)(int)color5.G * num10 + (float)(int)color6.G * num9);
					newColor.B = (byte)((float)(int)color5.B * num10 + (float)(int)color6.B * num9);
				}
			}
			else if (Main.time < 16200.0)
			{
				float num11 = (float)(Main.time / 16200.0);
				float num12 = 1f - num11;
				newColor.R = (byte)((float)(int)color6.R * num12 + (float)(int)color7.R * num11);
				newColor.G = (byte)((float)(int)color6.G * num12 + (float)(int)color7.G * num11);
				newColor.B = (byte)((float)(int)color6.B * num12 + (float)(int)color7.B * num11);
			}
			else
			{
				float num13 = 16200f;
				float num14 = (float)((Main.time - (double)num13) / (32400.0 - (double)num13));
				float num15 = 1f - num14;
				newColor.R = (byte)((float)(int)color7.R * num15 + (float)(int)color4.R * num14);
				newColor.G = (byte)((float)(int)color7.G * num15 + (float)(int)color4.G * num14);
				newColor.B = (byte)((float)(int)color7.B * num15 + (float)(int)color4.B * num14);
			}
			return newColor;
		}));
		...
		{
			int num5 = ((Main.netMode != 0) ? player.team : 0);
			if (num5 >= 0 && num5 < Main.teamColor.Length)
			{
				newColor = Main.teamColor[num5];
			}
			return newColor;
		}));
