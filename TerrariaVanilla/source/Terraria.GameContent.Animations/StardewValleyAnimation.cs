...
public class StardewValleyAnimation
{
	...
	private void ComposeAnimation()
	{
		...
		DrawData data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 0.5f), 1f, SpriteEffects.None);
		int targetTime = 128;
		int num = 60;
		int num2 = 360;
		int duration = 60;
		...
		DrawData data2 = new DrawData(val2.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 0.5f), 1f, SpriteEffects.None);
