...
public class WallDrawing : TileDrawingBase
{
	...
	public Texture2D GetWallDrawTexture(int wallType, int paintColor)
	{
		...
		TilePaintSystemV2.WallVariationKey wallVariationKey2 = wallVariationKey;
		if (_lastPaintLookupKey == wallVariationKey2)
		{
			return _lastPaintLookupTexture;
		}
		_lastPaintLookupKey = wallVariationKey2;
		_lastPaintLookupTexture = LookupWallDrawTexture(wallVariationKey2);
		return _lastPaintLookupTexture;
	}
