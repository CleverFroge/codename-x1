...
public class OGGAudioTrack : ASoundEffectBasedAudioTrack
{
	...
	private void TryReadingTag(System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IReadOnlyList<string>> tags, string entryName, ref int result)
	{
