...
public class ItemDropDatabase
{
	...
	private void RegisterDD2EventDrops()
	{
		...
		RegisterToNPC(564, new DropBasedOnExpertMode(ItemDropRule.NotScalingWithLuck(3814, 2), ItemDropRule.NotScalingWithLuck(3814)));
		RegisterToNPC(564, new DropBasedOnExpertMode(ItemDropRule.NotScalingWithLuck(3815, 2, 4, 4), ItemDropRule.NotScalingWithLuck(3815, 1, 4, 4)));
		...
		RegisterToNPC(565, new DropBasedOnExpertMode(ItemDropRule.NotScalingWithLuck(3814, 8), ItemDropRule.NotScalingWithLuck(3814, 4)));
		RegisterToNPC(565, new DropBasedOnExpertMode(ItemDropRule.NotScalingWithLuck(3815, 8, 4, 4), ItemDropRule.NotScalingWithLuck(3815, 4, 4, 4)));
	...
	private void RegisterMiscDrops()
	{
		...
		RegisterToNPC(110, ItemDropRule.Common(1321, 40));
