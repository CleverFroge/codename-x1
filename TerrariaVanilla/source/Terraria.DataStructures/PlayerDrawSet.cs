...
public struct PlayerDrawSet
{
	...
	public void BoringSetup(Player player, List<DrawData> drawData, List<int> dust, List<int> gore, Vector2 drawPosition, float shadowOpacity, float rotation, Vector2 rotationOrigin, Projectile overrideHeldProjectile)
	{
		...
		colorElectricity = new Color((byte)255, (byte)255, (byte)255, (byte)100);
		...
		if (drawPlayer.head == 169)
		{
			...
			headGlowColor = new Color(b, b, b, (byte)0);
		}
		else if (drawPlayer.head == 216)
		{
			headGlowMask = 256;
			byte b2 = 127;
			headGlowColor = new Color(b2, b2, b2, (byte)0);
		}
		else if (drawPlayer.head == 210)
		{
			headGlowMask = 242;
			byte b3 = 127;
			headGlowColor = new Color(b3, b3, b3, (byte)0);
		}
		...
		{
			headGlowMask = 273;
			headGlowColor = new Color((byte)230, (byte)230, (byte)230, (byte)60);
		}
		...
		{
			headGlowMask = 305;
			headGlowColor = new Color((byte)200, (byte)200, (byte)200, (byte)150);
		}
		...
		else if (drawPlayer.head == 170)
		{
			...
			headGlowColor = new Color(b4, b4, b4, (byte)0);
		}
		else if (drawPlayer.head == 189)
		{
			headGlowMask = 184;
			byte b5 = (byte)(62.5f * (float)(1 + num5));
			headGlowColor = new Color(b5, b5, b5, (byte)0);
			colorArmorHead = drawPlayer.GetImmuneAlphaPure(new Color(b5, b5, b5, (byte)255), shadow);
		}
		else if (drawPlayer.head == 171)
		{
			byte b6 = (byte)(62.5f * (float)(1 + num4));
			colorArmorHead = drawPlayer.GetImmuneAlphaPure(new Color(b6, b6, b6, (byte)255), shadow);
		}
		else if (drawPlayer.head == 175)
		{
			headGlowMask = 41;
			headGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)0);
		}
		else if (drawPlayer.head == 193)
		{
			headGlowMask = 209;
			headGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)127);
		}
		...
		else if (drawPlayer.head == 282)
		{
			...
			num7 *= num7;
			headGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)0) * num7;
		}
		...
		{
			headGlowMask = 375;
			headGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)255);
		}
		...
		if (drawPlayer.body == 175)
		{
			...
			bodyGlowColor = new Color(b7, b7, b7, (byte)0);
		}
		...
		{
			bodyGlowColor = new Color((byte)230, (byte)230, (byte)230, (byte)60);
			armGlowColor = new Color((byte)230, (byte)230, (byte)230, (byte)60);
		}
		...
		{
			bodyGlowColor = new Color((byte)200, (byte)200, (byte)200, (byte)150);
			armGlowColor = new Color((byte)200, (byte)200, (byte)200, (byte)150);
		}
		else if (drawPlayer.body == 190)
		{
			...
			bodyGlowColor = new Color(b8, b8, b8, (byte)0);
			armGlowColor = new Color(b8, b8, b8, (byte)0);
			colorArmorBody = drawPlayer.GetImmuneAlphaPure(new Color(b8, b8, b8, (byte)255), shadow);
		}
		else if (drawPlayer.body == 176)
		{
			...
			bodyGlowColor = new Color(b9, b9, b9, (byte)0);
			armGlowColor = new Color(b9, b9, b9, (byte)0);
		}
		else if (drawPlayer.body == 194)
		{
			bodyGlowMask = 210;
			armGlowMask = 211;
			bodyGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)127);
			armGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)127);
		}
		else if (drawPlayer.body == 177)
		{
			byte b10 = (byte)(62.5f * (float)(1 + num4));
			colorArmorBody = drawPlayer.GetImmuneAlphaPure(new Color(b10, b10, b10, (byte)255), shadow);
		}
		else if (drawPlayer.body == 179)
		{
			...
			armGlowMask = 44;
			bodyGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)0);
			armGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)0);
		}
		if (drawPlayer.legs == 111)
		{
			legsGlowMask = 17;
			byte b11 = (byte)(62.5f * (float)(1 + num3));
			legsGlowColor = new Color(b11, b11, b11, (byte)0);
		}
		...
		{
			legsGlowMask = 274;
			legsGlowColor = new Color((byte)230, (byte)230, (byte)230, (byte)60);
		}
		...
		{
			legsGlowMask = 306;
			legsGlowColor = new Color((byte)200, (byte)200, (byte)200, (byte)150);
		}
		...
		else if (drawPlayer.legs == 110)
		{
			...
			legsGlowColor = new Color(b12, b12, b12, (byte)0);
		}
		else if (drawPlayer.legs == 112)
		{
			byte b13 = (byte)(62.5f * (float)(1 + num4));
			colorArmorLegs = drawPlayer.GetImmuneAlphaPure(new Color(b13, b13, b13, (byte)255), shadow);
		}
		else if (drawPlayer.legs == 134)
		{
			legsGlowMask = 212;
			legsGlowColor = new Color((byte)255, (byte)255, (byte)255, (byte)127);
		}
		else if (drawPlayer.legs == 130)
		{
			byte b14 = (byte)(127 * (1 + num5));
			legsGlowMask = 187;
			legsGlowColor = new Color(b14, b14, b14, (byte)0);
			colorArmorLegs = drawPlayer.GetImmuneAlphaPure(new Color(b14, b14, b14, (byte)255), shadow);
		}
		...
		{
			int alpha = 175;
			Color newColor = new Color((byte)0, (byte)80, (byte)255, (byte)100);
			if (Main.rand.Next(4) != 0 && shadow == 0f)
			{
		...
		if (drawPlayer.drippingSparkleSlime)
		{
			...
			if (Main.rand.Next(4) != 0 && shadow == 0f)
			{
				...
				if (Main.rand.Next(30) == 0)
				{
					...
					color2.A /= 2;
					Dust dust13 = Dust.NewDustDirect(position3, drawPlayer.width + 4, drawPlayer.height + 2, 43, 0f, 0f, 254, new Color((byte)127, (byte)127, (byte)127, (byte)0), 0.45f);
					dust13.noLight = true;
		...
		if (drawPlayer.slowOgreSpit && FocusHelper.AllowPlayerToEmitEffects)
		{
			...
			if (Main.rand.Next(5) == 0 && shadow == 0f)
			{
				...
				if (dust20.type == 4)
				{
					dust20.color = new Color((byte)80, (byte)170, (byte)40, (byte)120);
				}
