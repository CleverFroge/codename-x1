...
public class UICreativePowersMenu : UIState
{
	...
	private void InitializePage()
	{
		...
		_infiniteItemsWindow = new UICreativeInfiniteItemsDisplay
		{
			HAlign = 0f,
			VAlign = 0.5f,
			Left = new StyleDimension(80f, 0f),
	...
	private List<UIElement> CreateMainPowerStrip()
	{
		...
		groupOptionButton.OnLeftClick += MainCategoryButtonClick;
		...
		_infiniteItemsButton = groupOptionButton;
		...
		groupOptionButton2.OnLeftClick += MainCategoryButtonClick;
		...
		groupOptionButton3.OnLeftClick += MainCategoryButtonClick;
		...
		groupOptionButton4.OnLeftClick += MainCategoryButtonClick;
		...
		groupOptionButton5.OnLeftClick += MainCategoryButtonClick;
		...
		groupOptionButton6.OnLeftClick += MainCategoryButtonClick;
	...
	private List<UIElement> CreateTimePowerStrip()
	{
		...
		groupOptionButton.OnLeftClick += TimeCategoryButtonClick;
		list.Add(groupOptionButton);
		return list;
	}
	...
	private List<UIElement> CreatePersonalPowerStrip()
	{
		...
		groupOptionButton.OnLeftClick += PersonalCategoryButtonClick;
		list.Add(groupOptionButton);
		return list;
	}
	...
	private List<UIElement> CreateWeatherPowerStrip()
	{
		...
		groupOptionButton.OnLeftClick += WeatherCategoryButtonClick;
		list.Add(groupOptionButton);
		...
		groupOptionButton2.OnLeftClick += WeatherCategoryButtonClick;
		list.Add(groupOptionButton2);
	...
	public override void Draw(SpriteBatch spriteBatch)
	{
		...
		{
			Rectangle hitbox = _infiniteItemsButton.GetDimensions().ToRectangle();
	...
	private void SetupGamepadPoints()
	{
		...
		List<SnapPoint> orderedPointsByCategoryName5 = _helper.GetOrderedPointsByCategoryName(snapPoints, "DynamicItemCollectionSlot");
