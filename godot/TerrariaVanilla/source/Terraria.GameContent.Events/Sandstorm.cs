...
public class Sandstorm
{
	...
	public static void EmitDust()
	{
		...
		weightedRandom.Add(new Color((byte)200, (byte)160, (byte)20, (byte)180), Main.SceneMetrics.GetTileCount(53) + Main.SceneMetrics.GetTileCount(396) + Main.SceneMetrics.GetTileCount(397));
		weightedRandom.Add(new Color((byte)103, (byte)98, (byte)122, (byte)180), Main.SceneMetrics.GetTileCount(112) + Main.SceneMetrics.GetTileCount(400) + Main.SceneMetrics.GetTileCount(398));
		weightedRandom.Add(new Color((byte)135, (byte)43, (byte)34, (byte)180), Main.SceneMetrics.GetTileCount(234) + Main.SceneMetrics.GetTileCount(401) + Main.SceneMetrics.GetTileCount(399));
		weightedRandom.Add(new Color((byte)213, (byte)196, (byte)197, (byte)180), Main.SceneMetrics.GetTileCount(116) + Main.SceneMetrics.GetTileCount(403) + Main.SceneMetrics.GetTileCount(402));
