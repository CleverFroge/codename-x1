...
public abstract class QuickLoad
{
	...
	public static void Load()
	{
		if (TryRead(out _loadedConfig) && ShiftHeld())
		{
			...
			if (Terraria.Utilities.MessageBox.Show("Quick Load skipped. Do you want to delete the configuration?", "", MessageBoxButtons.YesNo) == DialogResult.Yes)
			{
				Clear();
			}
		}
