...
public class BannerClaimingUI : IPipsUI
{
	...
	public void DrawBannersGrid(SpriteBatch spriteBatch)
	{
		...
		if (_gridStartingElementIndex > 0)
		{
			...
			spriteBatch.Draw(TextureAssets.CraftUpButton.Value, new Vector2(num11, num12), null, new Color((byte)200, (byte)200, (byte)200, (byte)200), 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
		}
		if (_gridStartingElementIndex < num - num5 * num6)
		{
			num12 += 20;
			...
			spriteBatch.Draw(TextureAssets.CraftDownButton.Value, new Vector2(num11, num12), null, new Color((byte)200, (byte)200, (byte)200, (byte)200), 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
		}
