	...
	public static class Sets
	{
		...
		public class BasicNPCPortrait : NPCPortraitProvider
		{
			...
			public virtual void GetDrawData(out Texture2D texture, out Rectangle drawFrame)
			{
				if (_image == null)
				{
					_image = Main.Assets.Request<Texture2D>(TexturePath, (AssetRequestMode)1);
				}
				texture = null;
				if (_image.IsLoaded)
				{
		...
		public static Dictionary<int, NPCDebuffImmunityData> DebuffImmunitySets = new Dictionary<int, NPCDebuffImmunityData>
		{
			...
			},
			{
				...
				new NPCDebuffImmunityData
				{
					SpecificallyImmuneTo = new int[3] { 31, 30, 375 }
				}
			},
			{
				14,
		...
		public static bool[] SearchSpawnSlotsInReverse = Factory.CreateBoolSet(222, 245);

		public static bool[] CannotSpawnInSlot0 = Factory.CreateBoolSet(134, 135, 136, 7, 8, 9, 10, 11, 12, 13, 14, 15, 39, 40, 41, 87, 88, 89, 90, 91, 92, 95, 96, 97, 98, 99, 100, 117, 118, 119, 375, 402, 412, 413, 414, 454, 455, 456, 457, 458, 459, 510, 511, 512, 513, 514, 515, 621, 622, 623);

		public static bool[] SkipUpdateInUnsyncedTiles = Factory.CreateBoolSet(true, 135, 136, 14, 15, 8, 9, 11, 12, 40, 41, 96, 97, 99, 100, 118, 119, 622, 623, 511, 512, 514, 515, 455, 456, 457, 458, 459, 89, 90, 91, 92, 413, 414);

		public static bool[] UsesMultiplayerProximitySyncing = Factory.CreateBoolSet(true, 398, 397, 396);

		public static bool[] NoMultiplayerSmoothingByType = Factory.CreateBoolSet(50, 657, 120, 245, 247, 248, 246, 370, 222, 398, 397, 396, 400, 401, 668, 70, 690);
		...
		public static bool[] TownCritter = Factory.CreateBoolSet(46, 148, 149, 230, 299, 300, 303, 337, 361, 362, 364, 366, 367, 443, 445, 447, 538, 539, 540, 583, 584, 585, 592, 593, 602, 607, 608, 610, 616, 617, 625, 626, 627, 639, 640, 641, 642, 643, 644, 645, 646, 647, 648, 649, 650, 651, 652, 687, 688);
		...
		public static Color[] MagicAuraColor = Factory.CreateCustomSet(Color.White, (short)54, new Color((byte)100, (byte)4, (byte)227, (byte)127), (short)108, new Color((byte)255, (byte)80, (byte)60, (byte)127), (short)160, new Color((byte)40, (byte)80, (byte)255, (byte)127), (short)20, new Color((byte)40, (byte)255, (byte)80, (byte)127), (short)663, Main.hslToRgb(0.92f, 1f, 0.78f, 127));
		...
		public static bool[] ShouldBeCountedAsBossForBestiary = Factory.CreateBoolSet(false, 517, 422, 507, 493, 13, 664);

		public static bool[] ShouldBeCountedAsBossForRainbowBoulders = Factory.CreateBoolSet(false, 517, 422, 507, 493, 13, 14, 15, 267, 36, 114, 664, 134, 135, 136, 128, 129, 130, 131, 245, 247, 248, 246, 491, 492, 392, 395, 394, 393, 564, 565, 576, 577, 551, 325, 327, 344, 345, 346);
