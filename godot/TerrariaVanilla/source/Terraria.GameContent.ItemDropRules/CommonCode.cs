...
public static class CommonCode
{
	...
	public static void ModifyItemDropFromNPC(NPC npc, int itemIndex)
	{
		...
		case 319:
			...
			{
			case 542:
				worldItem.color = new Color((byte)189, (byte)148, (byte)96, (byte)255);
				NetMessage.SendData(88, -1, -1, null, itemIndex, 1f);
				break;
			case 543:
				worldItem.color = new Color((byte)112, (byte)85, (byte)89, (byte)255);
				NetMessage.SendData(88, -1, -1, null, itemIndex, 1f);
				break;
			case 544:
				worldItem.color = new Color((byte)145, (byte)27, (byte)40, (byte)255);
				NetMessage.SendData(88, -1, -1, null, itemIndex, 1f);
				break;
			case 545:
				worldItem.color = new Color((byte)158, (byte)113, (byte)164, (byte)255);
				NetMessage.SendData(88, -1, -1, null, itemIndex, 1f);
				break;
			}
			break;
