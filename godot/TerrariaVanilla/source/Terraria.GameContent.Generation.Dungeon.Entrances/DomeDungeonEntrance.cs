...
public class DomeDungeonEntrance : DungeonEntrance
{
	...
	public void DomeEntrance(DungeonData data, int i, int j, bool generating)
	{
			...
			for (int n = -num4; n <= num4; n++)
			{
				for (int num12 = num10; num12 < num11; num12++)
				{
					...
					if (num12 == 1 && (n == -num3 + num2 || n == num3 - num2 * 2))
					{
						...
						dungeonPlatformData.Position = new Point(num13, num14);
						dungeonPlatformData.OverrideHeightFluff = 0;
						dungeonPlatformData.ForcePlacement = true;
						dungeonPlatformData.PlacePotsChance = 0.33000001311302185;
		...
		if (generating)
		{
			...
			new DungeonPillar(dungeonPillarSettings).GenerateFeature(data, i + num3 - 21, num7);
			DungeonPlatformData dungeonPlatformData = default(DungeonPlatformData);
			dungeonPlatformData.Position = new Point(i - num3 + 15, num7 - 25);
			dungeonPlatformData.OverrideHeightFluff = 0;
			dungeonPlatformData.ForcePlacement = true;
			dungeonPlatformData.PlacePotsChance = 0.33000001311302185;
			dungeonPlatformData.PlaceBooksChance = 0.75;
			dungeonPlatformData.PlacePotionBottlesChance = 0.10000000149011612;
			dungeonPlatformData.NoWaterbolt = true;
			DungeonPlatformData item3 = dungeonPlatformData;
			data.dungeonPlatformData.Add(item3);
			dungeonPlatformData = default(DungeonPlatformData);
			dungeonPlatformData.Position = new Point(i + num3 - 15, num7 - 25);
			dungeonPlatformData.OverrideHeightFluff = 0;
			dungeonPlatformData.ForcePlacement = true;
			dungeonPlatformData.PlacePotsChance = 0.33000001311302185;
			...
			dungeonPlatformData.PlacePotionBottlesChance = 0.10000000149011612;
			dungeonPlatformData.NoWaterbolt = true;
			item3 = dungeonPlatformData;
			data.dungeonPlatformData.Add(item3);
			dungeonPlatformData = default(DungeonPlatformData);
			dungeonPlatformData.Position = new Point(i - num3 + 15, num7 - 20);
			dungeonPlatformData.OverrideHeightFluff = 0;
			dungeonPlatformData.ForcePlacement = true;
			dungeonPlatformData.PlacePotsChance = 0.33000001311302185;
			dungeonPlatformData.PlaceBooksChance = 0.75;
