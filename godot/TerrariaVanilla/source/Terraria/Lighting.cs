...
public class Lighting
{
	...
	public static void GetColor4Slice(int centerX, int centerY, ref Color[] slices)
	{
		...
		if (num >= num4)
		{
			...
			slices[0] = new Color((byte)num5, (byte)num6, (byte)num7, (byte)255);
		}
		else
		{
			...
			slices[0] = new Color((byte)num8, (byte)num9, (byte)num10, (byte)255);
		}
		if (num >= num3)
		{
			...
			slices[1] = new Color((byte)num11, (byte)num12, (byte)num13, (byte)255);
		}
		else
		{
			...
			slices[1] = new Color((byte)num14, (byte)num15, (byte)num16, (byte)255);
		}
		if (num2 >= num4)
		{
			...
			slices[2] = new Color((byte)num17, (byte)num18, (byte)num19, (byte)255);
		}
		else
		{
			...
			slices[2] = new Color((byte)num20, (byte)num21, (byte)num22, (byte)255);
		}
		if (num2 >= num3)
		{
			...
			slices[3] = new Color((byte)num23, (byte)num24, (byte)num25, (byte)255);
		}
		else
		{
			...
			slices[3] = new Color((byte)num26, (byte)num27, (byte)num28, (byte)255);
		}
	}
