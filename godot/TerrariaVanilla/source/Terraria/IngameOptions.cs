...
public static class IngameOptions
{
	...
	public static void Draw(Main mainInstance, SpriteBatch sb)
	{
		...
		Utils.DrawInvBG(sb, vector3.X - (float)num4, vector3.Y - (float)num4, vector2.X + (float)(num4 * 2), vector2.Y + (float)(num4 * 2), new Color((byte)33, (byte)15, (byte)91, (byte)255) * 0.685f);
		...
		if (category == 0)
		{
			...
			if (DrawRightSide(sb, textValue2, num14, vector6, vector7, rightScale[num14], (rightScale[num14] - num5) / (num6 - num5)))
			{
				rightHover = num14;
				if (flag4)
				{
		...
		if (category == 1)
		{
			...
			if (DrawRightSide(sb, Language.GetTextValue("UI.SelectHealthStyle", textValue4), num17, vector6, vector7, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
			{
				rightHover = num17;
				if (flag4)
				{
			...
			}, num17, vector6, vector7, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
			{
				rightHover = num17;
				if (flag4)
				{
			...
			if (DrawRightSide(sb, textValue5, num17, vector6, vector7, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
			{
				rightHover = num17;
				if (flag4)
				{
			...
			num17++;
			string txt = (ItemSlot.Options.DisableQuickTrash ? Lang.menu[253].Value : (ItemSlot.Options.DisableLeftShiftTrashCan ? Lang.menu[224].Value : Lang.menu[223].Value));
			if (DrawRightSide(sb, txt, num17, vector6, vector7, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
			{
				rightHover = num17;
				if (flag4)
				{
			...
			if (DrawRightSide(sb, textValue6, num17, vector6, vector7, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
			{
				rightHover = num17;
				if (flag4)
				{
		...
		if (category == 2)
		{
			...
			num19++;
			if (DrawRightSide(sb, Language.GetTextValue("GameUI.ForegroundSunlightEffects", Main.ForegroundSunlightEffects ? Language.GetTextValue("GameUI.Enabled") : Language.GetTextValue("GameUI.Disabled")), num19, vector6, vector7, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
			{
				rightHover = num19;
				if (flag4)
				{
			...
			num19++;
			if (DrawRightSide(sb, Language.GetTextValue("GameUI.ScreenShake", Main.UseScreenShake ? Language.GetTextValue("GameUI.Enabled") : Language.GetTextValue("GameUI.Disabled")), num19, vector6, vector7, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
			{
				rightHover = num19;
				if (flag4)
				{
			...
			if (DrawRightSide(sb, textValue7, num19, vector6, vector7, rightScale[num19], (rightScale[num19] - num5) / (num6 - num5)))
			{
				rightHover = num19;
				if (flag4)
				{
		...
		if (category == 3)
		{
			...
			if (DrawRightSide(sb, txt2, num22, vector6, vector7, rightScale[num22] * 0.9f, (rightScale[num22] - num5) / (num6 - num5)))
			{
				rightHover = num22;
				if (flag4)
				{
