...
public class Dust
{
	...
	public static Dust QuickDustSmall(Vector2 pos, Color color, bool floorPositionValues = false)
	{
		...
		{
			dust.position = Utils.Floor(dust.position);
		}
		return dust;
	}
	...
	public Color GetAlpha(Color newColor)
	{
		...
		case 308:
		case 309:
			return new Color((byte)225, (byte)200, (byte)250, (byte)190);
		case 324:
			return new Color((byte)225, (byte)200, (byte)250, (byte)190) * num;
		case 299:
		case 300:
		case 301:
		case 305:
		{
			...
			return type switch
			{
				299 => new Color((byte)50, (byte)255, (byte)50, (byte)200), 
				300 => new Color((byte)50, (byte)200, (byte)255, (byte)255), 
				301 => new Color((byte)255, (byte)50, (byte)125, (byte)200), 
				305 => new Color((byte)200, (byte)50, (byte)200, (byte)200), 
		...
		default:
		{
			...
			if (type == 259)
			{
				return new Color((byte)230, (byte)230, (byte)230, (byte)230);
			}
			if (type == 261)
			{
				return new Color((byte)230, (byte)230, (byte)230, (byte)115);
			}
			...
			if (type == 258)
			{
				return new Color((byte)150, (byte)50, (byte)50, (byte)0);
			}
			...
			if (type == 197)
			{
				return new Color((byte)250, (byte)250, (byte)250, (byte)150);
			}
			...
			if (type == 159)
			{
				return new Color((byte)250, (byte)250, (byte)250, (byte)50);
			}
			if (type == 163 || type == 205)
			{
				return new Color((byte)250, (byte)250, (byte)250, (byte)0);
			}
			if (type == 170)
			{
				return new Color((byte)200, (byte)200, (byte)200, (byte)100);
			}
			if (type == 180)
			{
				return new Color((byte)200, (byte)200, (byte)200, (byte)0);
			...
			if (type == 183)
			{
				return new Color((byte)50, (byte)0, (byte)0, (byte)0);
			}
			if (type == 172)
			{
				return new Color((byte)250, (byte)250, (byte)250, (byte)150);
			...
			if (type == 160 || type == 162 || type == 164 || type == 173)
			{
				...
				return new Color(num3, num3, num3, (byte)0);
			}
			...
			{
				return new Color(newColor.R, newColor.G, newColor.B, (byte)25);
			}
			...
			if (type == 270)
			{
				return new Color(newColor.R / 2 + 127, newColor.G / 2 + 127, newColor.B / 2 + 127, (byte)25);
			}
			if (type == 271)
			{
				return new Color(newColor.R / 2 + 127, newColor.G / 2 + 127, newColor.B / 2 + 127, (byte)127);
			}
			...
			if (type == 327 && !Main.dayTime)
			{
				...
				num4 = (int)(Main.rand.NextFloat() * 0.04f + 0.1f + (float)Main.DiscoB / 800f) * 255;
				if (num6 > newColor.R)
				{
			...
			else
			{
				...
				if (type == 66)
				{
					return new Color(newColor.R, newColor.G, newColor.B, (byte)0);
				}
				if (type == 267)
				{
					return new Color(this.color.R, this.color.G, this.color.B, (byte)0);
				}
				if (type == 71)
				{
					return new Color((byte)200, (byte)200, (byte)200, (byte)0);
