...
public static class TimeLogger
{
	...
	{
		StartTimestamp result = default(StartTimestamp);
	...
	private static void DrawTimes()
	{
		...
		Main.spriteBatch.Draw(TextureAssets.MagicPixel.Value, new Rectangle(0, num, TableWidth, 800), new Color((byte)60, (byte)60, (byte)60, (byte)80));
	...
	private static void DrawEntry(TimeLogData e, ref int y, int indent = 0)
	{
		...
		{
			Main.spriteBatch.Draw(TextureAssets.MagicPixel.Value, new Rectangle(0, y, TableWidth, 12), new Color((byte)0, (byte)0, (byte)0, (byte)80));
		}
		int num = 0;
